    ...
    <motion.div className="services" variants={variants} initial="initial" animate={"animate"}>
      ...
      <motion.div className="listContainer" variants={variants}>
        <motion.div className="box" whileHover={{backgroundColor:"lightgray", color:"black"}}>
            <h2>Branding</h2>
            <p>
                lkasjkjh hshdgh hahgsytr jsjoipo woiqiu bashvhcvxchcgdfyt jxbh
                xjhaasgxiushiuxhjjn mnkjh aoiouih qppokms njhugygh ajnsjxh
                jxbshbxhsbxyy jgygygy ppoiytw ahsjkznbgyt nbdhsbhshn
            </p>
            <button>Go</button>
        </motion.div>
